...
public class FileSinkDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        env.getCheckpointConfig().setCheckpointStorage("file:///Users/owisho/Desktop/checkpoints");//注意：使用fileSink时必须开启checkpoint
        ...
        }, Long.MAX_VALUE, TypeInformation.of(String.class));
        ...
        FileSink<String> fileSink = FileSink
                ...
                .withRollingPolicy(DefaultRollingPolicy.builder()
                        ...
                        .withRolloverInterval(Duration.ofSeconds(3)).build()).build();
